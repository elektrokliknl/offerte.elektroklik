...
(function () {
  ...
  function toonDetailsBlok() {
    ...
    if (sub) {
      var teksten = {
        ...
        airco:       'Een paar korte vragen over uw situatie.',
  ...
  function valideerStap3() {
    ...
    if (dienst === 'airco') {
      checkRadio('ac_woning');
      checkRadio('ac_ruimte');
      checkRadio('ac_muur');
      checkRadio('ac_toestel');
      checkSelect('ac-wanneer', 'ac_wanneer');
    }
  ...
  function verstuurFormulier() {
    ...
    var dienst = getGekozenDienst();
    var prefixMap = { laadpaal: 'lp_', groepenkast: 'gk_', fornuis: 'fn_', airco: 'ac_' };
